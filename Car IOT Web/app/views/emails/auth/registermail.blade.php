...
<div align="center" style="background-color:#ecf0f1;">
				...
				<table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="50%" style="text-align:left;">
							<a href="#" style="text-decoration:none;"><h3 style="font-size: 25px;font-family: 'Helvetica Neue', helvetica, arial, sans-serif;font-weight: bold;color: #6B6B6B;margin: 0;"> CarIO</h3></a>
						</td>
	...
	<table id="email-penrose-conteneur" width="660" align="center" style="border-right:1px solid #e2e8ea; border-bottom:1px solid #e2e8ea; border-left:1px solid #e2e8ea; background-color:#ffffff;" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td style="background-color:#7D409B">
				<table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
							<span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a href="#" style="color:#ffffff; outline:none; text-decoration:none;">Welcome to CarIO
            </a>, <b>{{$name}}</b></a> </span>
						</td>
					</tr>
					...
					<tr>
						<td width="100%">
							...
							<table width="100%" align="right" class="resp-full-table" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="40%" class="resp-full-td" valign="top" style="text-align : justify;">
										
										<div style="text-align:center;font-size: 12px;"><b>Registered Email</b></div>
										<br>
									</td>

									<td width="60%" class="resp-full-td" valign="top" style="text-align : justify;">
										
										<div style="font-size: 14px;">: <b>{{$email}}</b></div>
										<br>
									</td>
								</tr>
								<tr>
									<td width="40%" class="resp-full-td" valign="top" style="text-align : justify;">
										...
										<div style="text-align:center;font-size: 12px;"><b>Your password</b></div>
										<br>
									</td>
									
									<td width="60%" class="resp-full-td" valign="top" style="text-align : justify;">
										
										<div style="font-size: 14px;">: <b>{{$password}}</b></div>
										<br>
									</td>
								</tr>
								<tr>
									<td width="40%" class="resp-full-td" valign="top" style="text-align : justify;">
										...
										<div style="text-align:center;font-size: 12px;"><b>Your cik</b></div>
										<br>
									</td>
									
									<td width="60%" class="resp-full-td" valign="top" style="text-align : justify;">
										
										<div style="font-size: 14px;">: <b>{{$cik}}</b></div>
										<br>
									</td>
								</tr>
                                <tr>
                                    <td width="40%" class="resp-full-td" valign="top" style="text-align : justify;">
                                        ...
                                        <div style="text-align:center;font-size: 12px;"><b>Your Dashboard Link</b></div>
                                        <br>
                                    </td>

                                    <td width="60%" class="resp-full-td" valign="top" style="text-align : justify;">

                                        <div style="font-size: 14px;">: <a href="{{$dashboard_link}}"><b>View Dashboard</b></a></div>
                                        <br>
                                    </td>
                                </tr>
